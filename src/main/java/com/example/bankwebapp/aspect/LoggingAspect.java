package com.example.bankwebapp.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.example.bankwebapp.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * com.example.bankwebapp.service.*.*(..))")
